...
class _Config:
    ...
    def _multiwoz_damd_init(self):
        ...
        self.vocab_path_train = './PPD/ppd-processed/vocab'
        self.vocab_path_eval = None
        self.data_path = './PPD/ppd-processed/'
        self.data_file = 'data_for_damd.json'
        self.dev_list = 'PPD/valListFile.json'
        self.test_list = 'PPD/testListFile.json'
        self.dbs = {
        ...
        self.domain_file_path = 'PPD/ppd-processed/domain_files.json'
        self.slot_value_set_path = 'ppd_db/value_set_processed.json'
        self.multi_acts_path = 'PPD/ppd-processed/multi_act_mapping_train.json'
